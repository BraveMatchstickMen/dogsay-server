...
exports.save = function *(next) {
    ...
    if (!creation) {
        ...
        var video_public_id = video_public_id
        var audio_public_id = audio_public_id

        if (video_public_id && audio_public_id) {
            creationData.cloudinary_thumb = 'http://res.cloudinary.com/db2oxpw9c/video/upload/' + video_public_id + '.jpg'
            creationData.cloudinary_video = 'http://res.cloudinary.com/db2oxpw9c/video/upload/e_volume:-100/e_volume:400,l_video:' + audio_public_id.replace('/', ':') + '/' + video_public_id + '.mp4'
